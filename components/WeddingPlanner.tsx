        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-stone-100 h-full">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <button className="mt-1 text-sm font-semibold text-orange-600 hover:text-orange-800">Start a new board &rarr;</button>
                </div>
                 <div>
                    <h3 className="font-semibold text-stone-700">Simplified Budget Tracker</h3>
                     <label htmlFor="budget" className="flex justify-between items-center text-sm font-medium text-stone-700 mt-1">
                        ...
                        <span className="font-bold text-orange-600">₹{budget.toLocaleString('en-IN')}</span>
                    </label>
                    <input
                        id="budget"
                        type="range"
                ...
                <div>
                    ...
                    <p className="text-sm text-stone-500">Find photographers, venues, and more.</p>
                     <a href="#" className="mt-1 text-sm font-semibold text-orange-600 hover:text-orange-800">Explore vendors &rarr;</a>
                </div>
            </div>
        </div>
    );
